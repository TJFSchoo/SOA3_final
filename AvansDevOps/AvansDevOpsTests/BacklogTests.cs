...
namespace AvansDevOpsTests
{
    public class BacklogTests
    {
        ...
        [Fact]
        public void Decreasing_State_Of_Backlog_Item_In_Finished_State_Gives_NotSupportedException()
        {
            // Arrange
            Project project = new Project("Test Project", new PersonModel("Tom", ERole.Lead));
            SprintFactory factory = new SprintFactory();
        ...
        [Fact]
        public void Increasing_State_Of_Backlog_Item_In_Finished_State_Gives_NotSupportedException()
        {
            // Arrange
            Project project = new Project("Test Project", new PersonModel("Tom", ERole.Lead));
            SprintFactory factory = new SprintFactory();
